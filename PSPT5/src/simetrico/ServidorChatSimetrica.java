...
public class ServidorChatSimetrica extends JFrame
{
	...
	public static void main(String args[]) throws Exception
	{
		...
		ServidorChatSimetrica pantalla = new ServidorChatSimetrica();
		...
		while(CONEXIONES < MAXIMO)
		{
			...
			CONEXIONES++;
			ACTUALES++;
			HiloServidorSimetrica hilo = new HiloServidorSimetrica(socket);
			hilo.start();
		}
